...
class UsingMethodExam{
	...
	*/	
	...
	public String methodExam03_02(String str, int num) {
		...
		int num2 = this.methodExam03_01(num);
	...
	*/	
	...
	protected double methodExam03_04(int num1, double num2, int num3) {
...
class UsingMethod{
	//메인메소드에서
		...
		// 리턴하는 값 있다면 출력
	public static void main(String[] 메롱) {
		UsingMethodExam usingMethodExam = new UsingMethodExam();
		System.out.println(usingMethodExam.methodExam03_02("안녕",2));
		usingMethodExam.methodExam03_03(2,"바보");
		System.out.println(usingMethodExam.methodExam03_04(3, 5.5, 4));
	}
