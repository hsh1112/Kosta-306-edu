...
public class MenuView {
	...
	private GoodsService goodsService = GoodsService.getInstance(); // 전역변수 초기화
	...
	public void printMenu() {// 메인에서 전달한 2차원배열의 주소값전달
		...
		while (true) {
			...
			case 1:
				...
				break;
			case 2:
				Goods[] goodsArr = goodsService.selectAll();
				EndView.printSelectAll(goodsArr,goodsService.getCount());
				break;
			case 3:
	...
	public void inputSelectByCode() {
		...
		Goods goods = goodsService.selectByCode(code);
	...
	public void inputUpdate() {
		...
		boolean re = goodsService.update(goods);
